  ...
  const publishStatusHandler = async () => {
    ...
    try {
      const response = await publishCourse({
        courseId,
        query: courseByIdData?.course.isPublished ? "false" : "true",
      });
      ...
      <Card>
        <CardHeader className="flex flex-row justify-between">
          ...
          <div className="space-x-2">
            <Button disabled={courseByIdData?.course.lectures.length === 0} variant="outline" onClick={publishStatusHandler}>
